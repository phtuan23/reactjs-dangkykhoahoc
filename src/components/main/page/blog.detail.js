                            ...
                            <div className="single-post">
                                ...
                                <div className="blog_details">
                                    ...
                                    <ul className="blog-info-link mt-3 mb-4">
                                        <li><NavLink to="#"><i className="fa fa-user"></i> Travel, Lifestyle</NavLink></li>
                                        <li><NavLink to="#"><i className="fa fa-comments"></i> 03 Comments</NavLink></li>
                                    </ul>
                                    <p className="excert">
                            ...
                            <div className="navigation-top">
                                <div className="d-sm-flex justify-content-between text-center">
                                    ...
                                    <ul className="social-icons">
                                        <li><NavLink to="https://www.facebook.com/sai4ull"><i className="fab fa-facebook-f"></i></NavLink></li>
                                        <li><NavLink to="#"><i className="fab fa-twitter"></i></NavLink></li>
                                        <li><NavLink to="#"><i className="fab fa-dribbble"></i></NavLink></li>
                                        <li><NavLink to="#"><i className="fab fa-behance"></i></NavLink></li>
                                    </ul>
                                </div>
                                            ...
                                            <div className="desc">
                                                ...
                                                <div className="d-flex justify-content-between">
                                                    <div className="d-flex align-items-center">
                                                        <h5>
                                                            <NavLink to="#">Emilly Blunt</NavLink>
                                                        </h5>
                                                        <p className="date">December 4, 2017 at 3:12 pm </p>
                                                    </div>
                                                    <div className="reply-btn">
                                                        <NavLink to="#" className="btn-reply text-uppercase">reply</NavLink>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
